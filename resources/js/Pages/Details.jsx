    ...
    const users = [
        {
            id: 1,
            name: "John Doe",
            profile_picture: "/assets/flores.jpeg",
            rating: 4.5,
        ...
        <>
            ...
            <div>
                ...
                <section className="relative flex flex-col items-center font-poppins pt-40 px-4">
                    <div className="w-full h-150 details-hero absolute top-0 left-0 -z-10"></div>
                            ...
                            <div className="p-6 w-full rounded-2xl bg-white shadow-lg border border-gray-200 mt-8">
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    ...
                                    <div className="flex items-center gap-6 justify-center">
                                        <button
                                            className="rounded-md bg-gray-200 transition-all hover:bg-gray-400 w-8 h-8 hover:cursor-point"
                                            onClick={() =>
                                                setTicketAmount(
                                                    ticketAmount - 1
                                                )
                ...
                <section className="container mx-auto font-poppins mb-32 px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mt-16">
                        {users.map((user) => {
                            return <ReviewCard key={user.id} user={user} />;
                        })}
                    </div>
