...
export default function Location() {
    ...
    const handlePageClick = (event) => {
        const newOffset = (event.selected * 3) % destinations.length;
        console.log(
                            ...
                            {categories.map((category) => {
                                ...
                                return (
                                    <button
                                        ...
                                        classNameName={`text-sm sm:text-base px-3 py-1.5 sm:py-3.5 sm:px-5 rounded-full hover:cursor-pointer transition-all
                                     ${
                                         isSelected
                    ...
                    <main className="container px-4 relative mx-auto mt-12 mb-32 z-10 font-poppins">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            ...
                            <ReactPaginate
                                ...
                                activeClassName="w-12 h-12 hover:cursor-pointer grid place-content-center rounded-full aspect-square text-gray-500 bh-primary-transparent text-primary-opaque font-medium font-poppins"
                            />
                        </div>
                    </main>
                </div>
